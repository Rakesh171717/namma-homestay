...
import com.example.namma_homestay.UserRole
...
fun SignUpScreen(
    ...
    onSignUpClick: (String, String, String, UserRole) -> Unit,
        ...
        Column(
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = "Choose how you will use Namma Homestay.",
                    ...
                    TextButton(onClick = onNavigateToLogin, enabled = !authUiState.isLoading) {
